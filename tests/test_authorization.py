...
from edith.security.authorization import AuthorizationScope, OutOfScopeError, assert_in_scope


def active_scope():
    return AuthorizationScope(engagement="lab", authorized_by="me@example.com",
                              expires="2099-01-01",
...
def test_in_scope_cidr_allowed():
    assert_in_scope("10.0.0.55", active_scope())
